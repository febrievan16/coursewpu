 <nav class="bg-gray-800">
        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <x-nav-link href="/contaq" :current="request()->is('contaq')">Contaq Us</x-nav-link>
            </div>
          </div>
        </div>
        <div class="hidden md:block">
    ...
    <el-disclosure id="mobile-menu" hidden class="block md:hidden">
      <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
        <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-white/5 hover:text-white" -->
        <x-nav-link-m href="/" :current="request()->is('/')">Home</x-nav-link-m>
        <x-nav-link-m href="/blog" :current="request()->is('blog')">Blog</x-nav-link-m>
        <x-nav-link-m href="/about" :current="request()->is('about')">About</x-nav-link-m>
        <x-nav-link-m href="/contaq" :current="request()->is('contaq')">Contaq Us</x-nav-link-m>
      </div>
